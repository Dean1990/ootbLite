...
/**
 * 自动连接指定WIFI
 * @see WifiConnUtils#connect(String, String, WifiCipherType)
...
public class WifiConnUtils {
    ...
    // 构造函数
    public WifiConnUtils(WifiManager wifiManager) {
    ...
    class ConnectRunnable implements Runnable {
        ...
        public void run() {
            ...
            DLog.d("enableNetwork status enable=" + enabled);
            boolean connected = wifiManager.reconnect();
            DLog.d("enableNetwork connected=" + connected);
        }
    }
