...
public class FileUtils {
    ...
    public static String getCacheTotalSize() throws Exception {
        long cacheSize = getFileOrDirSize(OotbConfig.app().getCacheDir());
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            cacheSize += getFileOrDirSize(OotbConfig.app().getExternalCacheDir());
        }
    ...
    public static void deleteCacheAll() {
        deleteDir(OotbConfig.app().getCacheDir());
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            deleteDir(OotbConfig.app().getExternalCacheDir());
        }
    }
...
//                            ", Segments: " + uri.getPathSegments().toString());
        ...
        // DocumentProvider
        if (isKitKat && DocumentsContract.isDocumentUri(OotbConfig.app(), uri)) {
...
//            else
    ...
    public static Uri getResIdToUri(int resourceId) {
        return Uri.parse("android.resource://" + OotbConfig.app().getPackageName() + "/" + resourceId);
    }
...
//    }
    ...
    public static String getDataColumn(Uri uri, String selection,
        ...
        try {
            cursor = OotbConfig.app().getContentResolver().query(uri, projection, selection, selectionArgs,
                    null);
