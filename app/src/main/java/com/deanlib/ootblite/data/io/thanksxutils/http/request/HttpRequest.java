package com.deanlib.ootblite.data.io.thanksxutils.http.request;
...
import com.deanlib.ootblite.data.io.thanksxutils.http.body.ProgressBody;
...
public class HttpRequest extends UriRequest {
    ...
    public void sendRequest() throws Throwable {
        ...
        if (responseCode == 204 || responseCode == 205) { // empty content
            ...
            try {
                httpException.setResult(IOUtils.readStr(this.getInputStream(), params.getCharset()));
            } catch (Throwable ignored) {
            }
            DLog.e(httpException.toString() + ", url: " + queryUrl);
            throw httpException;
        }
