...
import com.deanlib.ootblite.data.io.thanksxutils.http.body.BodyItemWrapper;
import com.deanlib.ootblite.data.io.thanksxutils.http.body.FileBody;
import com.deanlib.ootblite.data.io.thanksxutils.http.body.InputStreamBody;
import com.deanlib.ootblite.data.io.thanksxutils.http.body.MultipartBody;
import com.deanlib.ootblite.data.io.thanksxutils.http.body.RequestBody;
import com.deanlib.ootblite.data.io.thanksxutils.http.body.StringBody;
import com.deanlib.ootblite.data.io.thanksxutils.http.body.UrlEncodedParamsBody;
            ...
            if (!multipart && fileParams.size() == 1) {
                for (KeyValue kv : fileParams) {
                    ...
                    if (value instanceof File) {
                        ...
                        DLog.w("Some params will be ignored for: " + this.toString());
                    }
                    break;
                }
            } else {
