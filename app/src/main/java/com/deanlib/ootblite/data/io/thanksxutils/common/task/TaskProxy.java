package com.deanlib.ootblite.data.io.thanksxutils.common.task;
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_ERROR: {
                        ...
                        DLog.d(throwable.getMessage(), throwable);
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((com.deanlib.ootblite.data.io.thanksxutils.common.Callback.CancelledException) args[0]);
                        break;
                    }
