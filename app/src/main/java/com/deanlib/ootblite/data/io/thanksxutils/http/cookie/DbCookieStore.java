package com.deanlib.ootblite.data.io.thanksxutils.http.cookie;
...
import com.deanlib.ootblite.data.io.thanksxutils.db.Selector;
...
public enum DbCookieStore implements CookieStore {
    ...
    DbCookieStore() {
        db = OotbConfig.getDb(DbConfigs.COOKIE.getConfig());
        try {
                    ...
                    if (!TextUtils.isEmpty(uri)) {
                        try {
                            ...
                            try {
                                ...
                                DLog.e(ignored.getMessage(), ignored);
                            }
                        }
                    }
                }
